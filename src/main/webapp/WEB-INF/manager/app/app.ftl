<@ms.html5>
	...
	<@ms.panel>
		<@ms.form isvalidation=true name="appForm"  action="${managerPath}/app/update.do">
			...
			<@ms.text name="appLoginPage" width="500" label="应用自定义登录界面" value="${app.appLoginPage?default('')}"  title="应用自定义登录界面" placeholder="请输入应用自定义登录界面" validation={"maxlength":"200","data-bv-stringlength-message":"应用自定义登录界面在200个字符以内!"} help="注：必须以http://或斜杠/开头"/>
